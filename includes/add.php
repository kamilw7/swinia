...
<tr>
<td align="left">
Imię (i nazwisko) świnii: </td><td> <input type="text" autocomplete="off" maxlength="17" name="kitten_name" style="width: 400px;" value="<?php if (isset($_POST['form_kitten_name'])) echo $_POST['form_kitten_name']; ?>" /> </td>
</tr>
<tr>
<td align="left">
